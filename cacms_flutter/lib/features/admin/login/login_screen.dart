...
class _AdminLoginScreenState extends State<AdminLoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (err?.errorCode == 'NETWORK_ERROR' || e.type == DioExceptionType.connectionError || e.type == DioExceptionType.connectionTimeout) {
        setState(() => _errorMessage = 'Cannot reach server.\nCheck your network and server URL.');
      } else {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text(
                      'Server: ${widget.apiClient.dio.options.baseUrl}',
